            ...
            <el-row class="rows clearfix" v-for="(item,index) in infor.cityLists" :key="index" style="border-bottom: 1px solid #ccc;">
                <el-col :span="8">
                    ...
                    <P>
                        ...
                        <el-input v-model="item.linkLinks"  placeholder="http://www.xxx.com" style="width: 150px; margin-bottom: 12px;"></el-input>
                    </P>
                    <P>
                ...
                <el-col :span="7">
                    ...
                    <P>
                        ...
                        <el-select v-model="item.isShowPics"
                ...
                <el-col :span="7">
                    <el-button type="primary" size="mini" @click='selectPic("imgUrl",infor.imgUrl,index)'>添加图片</el-button>
                    <el-button type="primary" size="mini"  v-on:click="delpic(index)" >删除图片</el-button>
                    <img :src="item.imgUrls" style="width: 180px; height: 70px; border: 1px solid #ccc; margin-top: 6px;">
                </el-col>

                <el-col :span="2">
                    <el-button type="warning" size="mini" v-on:click="deleteRow(index)">删除行</el-button>
                </el-col>
            </el-row>
        </el-tab-pane>
